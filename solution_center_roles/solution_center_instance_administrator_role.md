...
## Grant the Solution Center Instance Developer role to a user account for an instance
### Steps:
1. On the left panel, click **Solutions**. A list of all the solutions for your company that have access to the solution center will be displayed.
2. Select your solution by clicking on the solution name.
3. Click the **Instances** tab. A list of all the instances for the selected solution will be displayed.
...
5. Click the **Users** tab. A list of all the users for your instance will be displayed.
6. To grant the role, select or lookup the desired use.
7. Under the **Assign Role/s** section, check the box next to the Solution Center Instance Developer role, and click the **Add** button.
...
## Create Vanity URLs for an instance -- Re-visit
### Steps:
1. On the left panel, click **Solutions**. A list of all the solutions for your company that have access to the solution center will be displayed.
2. Select your solution by clicking on the solution name.
3. Click the **Instances** tab. A list of all the instances for the selected solution will be displayed.
...
## Delete the Vanity URLs for an instance -- Re-visit
### Steps:
1. On the left panel, click **Solutions**. A list of all the solutions for your company that have access to the solution center will be displayed.
2. Select your solution by clicking on the solution name.
3. Click the **Instances** tab. A list of all the instances for the selected solution will be displayed.
